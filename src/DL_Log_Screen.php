...
class DL_Log_Screen extends DL_Screen_Prototype {
    ...
    public function __construct( \WP_Screen $screen = null ) {
        ...
        $this->help_tabs[] = [
            ...
            'content' => sprintf(
                    '<p>%1$s</p>' .
                    '<h4 class="help-title">%2$s</h4>' .
                    '<ul class="help-list">' .
                        '<li><strong>%3$s</strong>&nbsp;&ndash;&nbsp;%4$s</li>' .
                        '<li><strong>%5$s</strong>&nbsp;&ndash;&nbsp;%6$s</li>' .
                        '<li><strong>%7$s</strong>&nbsp;&ndash;&nbsp;%8$s</li>' .
                        '<li><strong>%9$s</strong>&nbsp;&ndash;&nbsp;%10$s</li>' .
                    '</ul>' .
                    '<h4 class="help-title">%11$s</h4>' .
                    '<ul class="help-list">' .
                        '<li><span class="dashicons dashicons-warning"></span><em>%17$s</em>&nbsp;&ndash;&nbsp;%12$s</li>' .
                        '<li><span class="dashicons dashicons-format-status"></span><em>%18$s</em>&nbsp;&ndash;&nbsp;%13$s</li>' .
                        '<li><span class="dashicons dashicons-editor-help"></span><em>%19$s</em>&nbsp;&ndash;&nbsp;%14$s</li>' .
                        '<li><span class="dashicons dashicons-thumbs-down"></span><em>%20$s</em>&nbsp;&ndash;&nbsp;%15$s</li>' .
                        '<li><span class="dashicons dashicons-flag"></span><em>%21$s</em>&nbsp;&ndash;&nbsp;%16$s</li>' .
                    '</ul>',
